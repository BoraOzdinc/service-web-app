...
const ItemDetailForm = ({
  ...
  const form = useForm<FormInput>({
    defaultValues: {
      ...
      dealerPrice: Number(itemData?.dealerPrice) ?? undefined,
      mainDealerPrice: Number(itemData?.mainDealerPrice) ?? undefined,
      multiPrice: Number(itemData?.multiPrice) ?? undefined,
      itemCode: itemData?.itemCode,
      singlePrice: Number(itemData?.singlePrice) ?? undefined,
